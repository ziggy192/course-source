...
public class UnicaCourseDetailCrawler implements Runnable {
	private static Logger logger = LoggerFactory.getLogger(UnicaCourseDetailCrawler.class.toString());
				...
				while (staxReader.hasNext()) {
					...
					if (event.isStartElement()) {
						...
						if (startElement.getName().getLocalPart().equals("div")
							...
							String authorDesHtml = ParserUtils.getAllHtmlContentAndJumpToEndElement(staxReader, startElement);
...
//				DummyDatabase.validateCourseAndSaveToDB(courseEntity);
